  ...
  const steps = [
    {
      ...
      description: "Share your destination, dates, and travel style to find the perfect match.",
      color: "text-cyan-500",
      bgColor: "bg-cyan-50",
    },
    {
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Getting started is simple. Just three steps to find your travel companions.
          </p>
        </div>
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                <div className={`${step.bgColor} w-24 h-24 rounded-2xl flex items-center justify-center`}>
                  <step.icon className={`w-12 h-12 ${step.color}`} />
                </div>
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold text-[#0a1628]">{step.title}</h3>
